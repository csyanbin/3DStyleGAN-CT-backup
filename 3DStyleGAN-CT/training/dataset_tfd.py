...
class TFRecordDataset:
    def __init__(self,
        ...
        img_shape = [s*32 for s in self.base_size] # e.g. 256x256x64 or 256x256x224
        img_shape.insert(0, 1) # 1x256x256x224
        ...
        def load_dicom_convert(folder, vmin=-250, vmax=650):
            ...
            images3d = np.zeros((self.shape[1], self.shape[2], len(files)))  # 256x256xN

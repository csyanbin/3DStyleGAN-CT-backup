#!/bin/bash
#rj name=3D-stylegan2-ENVcon256 queue=hpi_ccta features=v100x4
...
python run_training.py --num-gpus=4 --data-dir=datasets --config=Gorig-Dres-3d-MG-base887 --dataset=ENVcon_tfrecord256 --total-kimg=6000

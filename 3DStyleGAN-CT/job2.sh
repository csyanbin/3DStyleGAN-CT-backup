#!/bin/bash
#rj name=3D-stylegan2-CT256 queue=hpi_ccta features=v100x4
...
python run_training.py --num-gpus=4 --data-dir=datasets --config=Gorig-Dres-R1-3d-MG-base882 --dataset=SCT_tfrecord256_2 --total-kimg=6000 --metrics=mmd_1K

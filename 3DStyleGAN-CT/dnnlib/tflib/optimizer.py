...
class Optimizer:
    ...
    def apply_updates(self, allow_no_op: bool = False) -> tf.Operation:
        ...
        # print( "===============================================================" )
        # print( "sum gradients across devices" )
        # print( "===============================================================" )
            ...
            with tfutil.absolute_name_scope(self.scope + "/Broadcast"), tf.device(None):
                for all_vars in zip(*[device.grad_clean.keys() for device in self._devices.values()]):
                    if len(all_vars) > 0 and all(dim > 0 for dim in all_vars[0].shape.as_list()): # NCCL does not support zero-sized tensors.
                        ...
                        # print( "===============================================================" )
                        # print( "all grads - nccl_ops.all_sum" )
                        # print( "===============================================================" )

                        all_grads = nccl_ops.all_sum(all_grads)

                        # print( "===============================================================" )
                        # print( "device grad_clean[var] = grad" )
                        # print( "===============================================================" )
        ...
        # print( "===============================================================" )
        # print( "Apply updates separately on each device" )
        # print( "===============================================================" )
        ...
        for device_idx, device in enumerate(self._devices.values()):
            with tfutil.absolute_name_scope(self.scope + "/Apply%d" % device_idx), tf.device(device.name):
                ...
                # print( "===============================================================" )
                # print( "Accumulate gradients over time" )
                # print( "===============================================================" )
                ...
                # print( "===============================================================" )
                # print( "No overflow ==> Apply Gradients" )
                # print( "===============================================================" )
                ...
                if device_idx == len(self._devices) - 1:
                    # print( "===============================================================" )
                    # print( "Last device ==> Report Statistics" )
                    # print( "===============================================================" )
        ...
        # print( "===============================================================" )
        # print( "Group everything into a single op" )
        # print( "===============================================================" )
    ...
    def reset_optimizer_state(self) -> None:
        ...
        # print( "===============================================================" )
        # print( "reset_optimizer_state_updates" )
        # print( self.name )
        # print( "===============================================================" )
...
class SimpleAdam:
    ...
    def apply_gradients(self, grads_and_vars):
        # print( "===============================================================" )
        # print( "SimpleAdam  apply_gradients  " )
        # print( self.name )
        # print( "===============================================================" )
        ...
        with tf.name_scope(self.name):
            ...
            # print( "===============================================================" )
            # print( "Construct ops to update each variable  " )
            # print( "===============================================================" )
            ...
            # print( "===============================================================" )
            # print( "Group everything together" )
            # print( "===============================================================" )

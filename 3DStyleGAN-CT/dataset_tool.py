    ...
    def add_image3d_base(self, img, base_size):
        ...
        for lod, tfr_writer in enumerate(self.tfr_writers):
            if lod:
                img = img.astype(np.float32)
                print(img.shape)
                print(img[:, 0::2, 0::2, 0::2].shape, img[:, 0::2, 0::2, 1::2].shape, img[:, 0::2, 1::2, 0::2].shape, img[:, 0::2, 1::2, 1::2].shape, img[:, 1::2, 0::2, 0::2].shape, img[:, 1::2, 0::2, 1::2].shape, img[:, 1::2, 1::2, 0::2].shape, img[:, 1::2, 1::2, 1::2].shape )
                img = (img[:, 0::2, 0::2, 0::2] + img[:, 0::2, 0::2, 1::2] + img[:, 0::2, 1::2, 0::2] + img[:, 0::2, 1::2, 1::2] + img[:, 1::2, 0::2, 0::2] + img[:, 1::2, 0::2, 1::2] + img[:, 1::2, 1::2, 0::2] + img[:, 1::2, 1::2, 1::2] ) * 0.125

...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, resume_pkl):
    train     = EasyDict(run_func_name='training.training_loop_2d.training_loop') # Options for training loop.
    ...
    if config_id == 'Gorig-Dres-R1-2d-MG-base88':
        dataset_args = EasyDict(tfrecord_dir=dataset)
        dataset_args.base_size = [8, 8] 

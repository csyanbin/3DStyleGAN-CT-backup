...
def training_loop(
    ...
    network_snapshot_ticks  = 500,       # How often to save network snapshots? None = only save 'networks-final.pkl'.
    ...
    with tf.device('/gpu:0'):
        if resume_pkl is None or resume_with_new_nets:
            ...
            D = tflib.Network('D', num_channels=training_set.shape[0], resolution=min_res, label_size=training_set.label_size, **D_args)
            Gs = G.clone('Gs')
    ...
    for gpu in range(num_gpus):
        with tf.name_scope('GPU%d' % gpu), tf.device('/gpu:%d' % gpu):
            ...
            lod_assign_ops = []
            if 'lod' in G_gpu.vars: lod_assign_ops += [tf.assign( G_gpu.vars['lod'], tf.cast( lod_in, tf.float32 ) ) ]
            if 'lod' in D_gpu.vars: lod_assign_ops += [tf.assign( D_gpu.vars['lod'], tf.cast( lod_in, tf.float32 ) )]
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        print('Training parameters and configurations')
        ...
        if reset_opt_for_new_lod:
            if np.floor(sched.lod) != np.floor(prev_lod) or np.ceil(sched.lod) != np.ceil(prev_lod):
                ...
                G_reg_opt.reset_optimizer_state(); D_reg_opt.reset_optimizer_state()
        ...
        for _repeat in range(minibatch_repeats):
            ...
            if len(rounds) == 1:
                ...
                if run_G_reg:
                    """
                    print( "=========================================" )
                    print( "Fast Path run_G_reg" )
                    print( "=========================================" )
                    """
                    tflib.run(G_reg_op, feed_dict)
                    """
                    print( "=========================================" )
                    print( "Done Fast Path run_G_reg" )
                    print( "=========================================" )
                    """
                """
                print( "=========================================" )
                print( "Fast Path run D_train_op" )
                print( "D_train_op" )
                print( D_train_op ) 
                print( "Gs_update_op" )
                print( Gs_update_op )
                ...
                if run_D_reg:
                    """
                    print( "=========================================" )
                    print( "Fast Path run_D_reg" )
                    print( "=========================================" )
                    """
                    tflib.run(D_reg_op, feed_dict)
                    """
                    print( "=========================================" )
                    print( "Done Fast Path run_D_reg" )
                    print( "=========================================" )
                    """
            ...
            # Slow path with gradient accumulation.
                ...
                if run_D_reg:
                    for _round in rounds:
                        """
                        print( "=========================================" )
                        print( "Slow Path run_D_reg" )
                        print( "=========================================" )
                        """
                        tflib.run(D_reg_op, feed_dict)
                        """
                        print( "=========================================" )
                        print( "Done: Slow Path run_D_reg" )
                        print( "=========================================" )
                        """
        ...
        if cur_tick < 0 or cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            if image_snapshot_ticks is not None and (cur_tick % image_snapshot_ticks == 0 or done):                
                grid_fakes = Gs.run(grid_latents, grid_labels, is_validation=True, minibatch_size=sched.minibatch_gpu)
                misc.save_3d_image_grid(grid_fakes, dnnlib.make_run_dir_path('fakes%06d.png' % (cur_nimg // 1000)), drange=drange_net, grid_size=grid_size)
            ...
            #print( "=======================================================" )
            #print( " Metrics Autosummary....  " )
            #print( "=======================================================" )
            #metrics.update_autosummaries()
            #print( "=======================================================" )
            #print( " Metrics Save Autosummary....  " )
            print( "=======================================================" )
            tflib.autosummary.save_summaries(summary_log, cur_nimg)
            # print( "=======================================================" )
            # print( " Contect Update....  " )
            # print( "=======================================================" )            
            ...
            # print( "=======================================================" )
            # print( " Cur_tick {} Done".format( cur_tick ) )
            # print( "=======================================================" )            
